...
export const PROJECTS: Project[] = [
  {
    ...
    title: "Run Delivery",
    tagline:
      "Dispatch, track, and pay for deliveries without the WhatsApp spreadsheet.",
    tag: "B2B logistics",
    ...
    roleLine: "full-stack · merchant dashboard + business API",
    summary:
    ...
    description:
      "I build the business product end to end: the Next.js dashboard at b2b-hub.rundeliverys.com, and the NestJS business-app that quotes a trip, debits a wallet in a Mongo transaction, hands the order to ops for assignment, and fans status out over Socket.IO, FCM, and signed webhooks.",
    stack: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
    ...
    links: [
      ...
      {
        label: "b2b-hub.rundeliverys.com",
        href: "https://b2b-hub.rundeliverys.com/",
      },
      { label: "API docs", href: "https://run-deliverys.mintlify.site/index" },
    ],
    changes: {
      before: [
        "Businesses book over calls, WhatsApp, and spreadsheets",
        "No shared quote, bulk drop-off, or checkout hook",
        "Ops and merchants not on the same dispatch as riders",
      ],
      after: [
        "Merchant dashboard + public Business API on NestJS dispatch",
        "Quote, wallet debit, and order write commit together",
        "HMAC webhooks, live GPS tracking, radius-based rider assignment",
      ],
    },
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Live at b2b-hub.rundeliverys.com, with public API docs for third-party checkout. Local Nigeria deliveries, wallet, assignment, live tracking, and webhooks are in daily use alongside the rider and consumer apps. Interstate and international lanes are stubbed in the UI.",
        ],
      },
    ],
  },
  {
    ...
    links: [
      {
        label: "babsautologistics.com",
        href: "https://babsautologistics.com/",
      },
    ],
    sections: [
      {
  ...
  },
  {
    ...
    title: "Trovo",
    tagline:
      "Buy data, airtime, and bills in seconds on the web, WhatsApp, or Telegram.",
    tag: "VTU platform",
    company: "Trovo",
    period: "May 2026",
    current: true,
    ...
    links: [
      ...
      {
        label: "WhatsApp bot",
        href: "https://wa.me/2349124904305?text=%2Fstart",
      },
  ...
  },
  {
    ...
    links: [
      {
        label: "App Store",
        href: "https://apps.apple.com/ng/app/klone-for-customer/id6755367040",
      },
      {
        label: "Google Play",
        href: "https://play.google.com/store/apps/details?id=com.klone_customer",
      },
  ...
  },
  {
    ...
    status: "In production",
    role: ["Frontend Development"],
    roleLine: "software engineer · web booking product",
    summary:
    ...
    changes: {
      before: [
        "Salons and spas taking appointments over calls and WhatsApp",
        "No single path from nearby search to paid ticket",
        "Location and checkout glued together with fragile browser APIs",
      ],
      after: [
        "Web booking: search, listings, provider pages, checkout, QR tickets",
        "Maps, promo codes, and Google sign-in on the same product",
        "IP geolocation fallback when device location fails",
      ],
    },
    sections: [
      {
