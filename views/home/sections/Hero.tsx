  ...
  return (
    <div className="border-b border-line">
      ...
      <div className="container flex items-center gap-4 py-6 sm:py-10">
        ...
        <Image src="/img/solomon.jpeg" alt={PROFILE.name} width={112} height={112} priority sizes="(min-width: 640px) 112px, 64px" className="size-16 shrink-0 rounded-full object-cover sm:size-28"
        />
