...
const DESTINATIONS = [
  { id: "home", label: "Home", href: "/", description: "Start here" },
  ...NAV_LINKS,
];
  ...
  return (
    <>
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="flex items-center gap-2 font-mono text-sm text-muted-foreground transition-colors hover:text-foreground cursor-pointer"
      >
        Menu
        <svg
        ...
        >
          ...
          <motion.path
            ...
            style={{ originX: "5.5px", originY: "10px" }}
            transition={{ duration: 0.25, ease: EASE }}
          />
        </svg>
      </motion.button>
            ...
            <div className="container flex min-h-svh flex-col py-10">
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="font-mono text-sm text-muted-foreground hover:text-foreground cursor-pointer"
                >
                  Close
                </motion.button>
              </motion.div>
                  ...
                  {DESTINATIONS.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        <Link
                          href={item.href}
                          className="group grid grid-cols-[2.5rem_1fr] items-baseline gap-3 border-b border-line py-4"
                        >
              ...
              <motion.div
                ...
                transition={{
                  duration: 0.4,
                  delay: 0.12 + DESTINATIONS.length * 0.06,
                  ease: EASE,
                }}
              >
