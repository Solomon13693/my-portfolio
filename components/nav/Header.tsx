...
import { cn, EASE_OUT, CV_LAB_SHELL_CLASS, isCvLabPath } from '@/lib'
...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line bg-background">
      <div className={cn('relative flex h-(--header-height) items-center gap-2', lab ? CV_LAB_SHELL_CLASS : 'container')}>
